...
<section class="page-header" style="padding-top:300px;margin-top:0px">			<!-- padding-top:300px -->
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="content">
					<h1 class="page-name">공연 수정</h1>
					<ol class="breadcrumb">
						<li><a href="index.jsp">Home</a></li>
						<li class="active">공연 수정</li>
					</ol>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="contact-form col-md-6 " >
					<form name="joinForm" method="post" action="ad_pf_modifyHandling_op.jsp" role="form" onsubmit="return checkValue()">
