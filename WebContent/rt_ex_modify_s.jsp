...
<section class="page-header sub_page" style="padding-top:300px;margin-top:0px">			<!-- padding-top:300px -->
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="content">
					<h1 class="page-name">개시전시수정</h1>
					<ol class="breadcrumb">
						<li><a href="index.jsp">Home</a></li>
						<li class="active">개시전시수정</li>
					</ol>
				</div>
			</div>
		</div>
			...
			<div class="row">
				...
				<div class="contact-form col-md-6 " >
					<form name="joinForm" method="post" action="joinHandling.jsp" role="form" onsubmit="return checkValue()">
							...
							<ul class="join_list">
								...
								<li class="join_input">
									<div class="input-group subscription-form">
										<input type="text" placeholder="전시이름을 입력하세요" class="form-control" name="name" id="name" onchange="ch(this)">
									</div>
						...
						<div class="form-group">
							<ul class="join_list">
								<li class="join_field">전시시작일</li>
								<li class="join_input"><input type="text" placeholder="전시시작일을 입력하여 수정하세요. ex)18.06.09" class="form-control" name="sdate" id="sdate"></li>
							</ul>
						</div>
						<div class="form-group">
							<ul class="join_list">
								<li class="join_field">전시종료일</li>
								<li class="join_input"><input type="text" placeholder="전시종료일을 입력하여 수정하세요. ex)18.06.10" class="form-control" name="edate" id="edate"></li>
							</ul>
						</div>
						<div class="form-group">
							<ul class="join_list">
								<li class="join_field">장소</li>
								<li class="join_input"><input type="text" placeholder="전시장소를 입력하여 수정하세요. " class="form-control" name="place" id="place"></li>
							</ul>
						</div>
						<div class="form-group">
							<ul class="join_list">
								<li class="join_field">전시회 가격</li>
								<li class="join_input"><input type="text" placeholder="가격을 입력하세요.  ex)100000" class="form-control" name="priceSeatR" id="priceSeatR"></li>
							</ul>
						</div>
