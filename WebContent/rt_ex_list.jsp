...
<section class="page-header sub_page" style="padding-top:300px;margin-top:0px">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="content">
					<h1 class="page-name">취업공지개시조회</h1>
					<ol class="breadcrumb">
						<li><a href="#">Home</a></li>
						<li class="active">취업공지개시조회</li>
					</ol>
				</div>
			</div>
		</div>
            ...
            <div class="product-list">
              <form method="post">
                <table class="table pf_list">
                  ...
                  <thead>
                 	<tr>
                 	  <td colspan="6" class="pf_list_title"><h5>취업공지개시완료</h5></td>
                 	</tr>
                    <tr>
                      <th style="vertical-align:middle; width:10%;">번호</th>
                      <th style="vertical-align:middle; width:15%;">제목</th>
              ...
              <form method="post">
                <table class="table pf_list">
                  ...
                  <thead>
                 	<tr>
                 	  <td colspan="6" class="pf_list_title"><h5>취업공지개시대기</h5></td>
                 	</tr>
                    <tr>
                      <tr>
                       <th style="vertical-align:middle; width:10%;">번호</th>
