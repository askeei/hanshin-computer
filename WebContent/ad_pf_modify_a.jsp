...
<section class="page-header" style="padding-top:300px;margin-top:0px">			<!-- padding-top:300px -->
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="content">
					<h1 class="page-name">공연등록수정</h1>
					<ol class="breadcrumb">
						<li><a href="index.jsp">Home</a></li>
						<li class="active">공연등록수정</li>
					</ol>
				</div>
			</div>
		</div>
			...
			<div class="row">
				...
				<div class="contact-form col-md-6 " >
					<form name="joinForm" method="post" action="joinHandling.jsp" role="form" onsubmit="return checkValue()">
						...
						<div class="form-group">
							<ul class="join_list">
								<li class="join_field">공연시간</li>
								<li class="join_input"><input type="text" placeholder="공연시간을 분으로 입력하세요. ex)2시간->120" class="form-control" name="time" id="time"></li>
							</ul>
						</div>
						...
						<div id="cf-submit" class="ad_btn_list">
							<input type="submit" class="btn btn-transparent ad_btn" value="공연수정">
