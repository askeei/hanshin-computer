...
<section class="page-header sub_page" style="padding-top:300px;margin-top:0px">			<!-- padding-top:300px -->
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="content">
					<h1 class="page-name">공지신청</h1>
					<ol class="breadcrumb">
						<li><a href="index.jsp">Home</a></li>
						<li class="active">공지신청</li>
					</ol>
				</div>
			</div>
		</div>
				...
				<div class="contact-form col-md-6 " >
					<form name="joinForm" method="post" action="joinHandling.jsp" role="form" onsubmit="return checkValue()">
						<div class="form-group">
							<ul class="join_list">
								<li class="join_field">공지이름</li>
								<li class="join_input">
									<div class="input-group subscription-form">
										<input type="text" placeholder="공지이름을 입력하세요" class="form-control" name="name" id="name" onchange="ch(this)">
									</div>
						...
						<div class="form-group">
							<ul class="join_list">
								<li class="join_field">공지일</li>
								<li class="join_input"><input type="text" placeholder="공지시작일을 입력하여 수정하세요. ex)18.06.09" class="form-control" name="sdate" id="sdate"></li>
							</ul>
						</div>
						...
						<div id="cf-submit" class="ad_btn_list">
							<input type="submit" class="btn btn-transparent ad_btn" value="공지신청">
