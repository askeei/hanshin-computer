...
<section class="page-header sub_page" style="padding-top:300px;margin-top:0px">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="content">
					<h1 class="page-name">학부공지사항 조회</h1>
					<ol class="breadcrumb">
						<li><a href="#">Home</a></li>
						<li class="active">학부공지사항 조회</li>
					</ol>
				</div>
			</div>
		</div>
            ...
            <div class="product-list">
              <form method="post">
                <table class="table pf_list">
                  ...
                  <thead>
                 	<tr>
                 	  <td colspan="6" class="pf_list_title"><h5>등록한 학부공지사항</h5></td>
                 	</tr>
                    <tr>
                      <th style="vertical-align:middle; width:25%;">제목</th>
                      <th style="vertical-align:middle; width:25%;">작성자</th>
              ...
              <form method="post">
                <table class="table pf_list">
                  <thead>
                 	<tr>
                 	  <td colspan="6" class="pf_list_title"><h5>신청한 학부공지사항</h5></td>
                 	</tr>
                    <tr>
                      <th style="vertical-align:middle; width:10%;">번호</th>
                      <th style="vertical-align:middle; width:20%;">제목</th>
                      <th style="vertical-align:middle; width:20%;">날짜</th>
                      <th style="vertical-align:middle; width:20%;">작성자</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td style="vertical-align:middle; "><%= b.getSdate() %></td>
