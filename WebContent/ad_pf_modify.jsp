...
<section class="page-header" style="padding-top:300px;margin-top:0px">			<!-- padding-top:300px -->
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="content">
					<h1 class="page-name">공연신청</h1>
					<ol class="breadcrumb">
						<li><a href="index.jsp">Home</a></li>
						<li class="active">공연신청</li>
					</ol>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="contact-form col-md-6 " >
					<form name="joinForm" method="post" action="ad_pf_modifyHandling.jsp" role="form" onsubmit="return checkValue()">
						...
						<div id="cf-submit" class="ad_btn_list">
							<input type="submit" class="btn btn-transparent ad_btn" value="공연신청">
				...
				<% 
					...
					if(msg.equals("1")){
						out.println("<center><h2> ☆★ 공연 수정이 완료되었습니다 ★☆ </h2></center>");
					}
					else{
						out.println("<center><h2> 다시 신청해주세요! </h2></center>");
					}
				}
